        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 my-3">
            ...
            <div class="row">
                ...
                <div CLASS="col-6">
                    <div class="lienlinkedin BOXLIEN">
                        <span class="iconelien"><i class="fa fa-linkedin align-items-center"></i></span><span class="textlien"> LINKEDIN </span>
                    </div>
                </div>
                ...
                <div CLASS="col-6 justify-content-center">
                    ...
                    <span class="iconelien"><i class="fa fa-github"></i></span><span class="textlien"> GITHUB </span>
                    </div>
                </div>
            </div>
            <br>
            <div class="row justify-content-around text-center">
                <div CLASS="col-6">
                    ...
                    <span class="iconelien"><i class="fa fa-question-circle"></i></span><span class="textlien"> ??? </span>
                    </div>
                </div>
                ...
                <div CLASS="col-6">
                    ...
                    <span class="iconelien"><i class="fa fa-globe"></i></span><span class="textlien">  PORTFOLIO </span>
                    </div>
                </div>
            </div>
